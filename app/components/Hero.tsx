  ...
  return (
    <section className="relative overflow-hidden bg-background text-foreground py-28 px-6">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <p className="mt-6 text-gray-600 dark:text-slate-400 text-lg max-w-3xl mx-auto">
          Explore the best AI tools for writing, coding, images, video,
          design, productivity, and more. Find powerful AI software in one
